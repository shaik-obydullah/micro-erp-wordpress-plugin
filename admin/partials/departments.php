...
$back_url = li_mi_erp_admin_url( 'departments' );
?>
<div class="wrap micro-erp-page">
	<h1 class="wp-heading-inline mb-3">
		<?php echo $editing ? esc_html__( 'Edit Department', 'lime-micro-erp' ) : esc_html__( 'Departments', 'lime-micro-erp' ); ?>
		<?php if ( ! $editing ) : ?>
			<a href="<?php echo esc_url( li_mi_erp_admin_url( 'departments', array( 'new' => '1' ) ) ); ?>" class="btn-primary"><?php esc_html_e( '+ Add Department', 'lime-micro-erp' ); ?></a>
		<?php endif; ?>
	</h1>
			...
			<div class="col-lg-6 col-md-12">
				<div class="bg-light p-4 rounded shadow-sm">
					...
					<form method="post" action="">
						...
						wp_nonce_field( 'li_mi_erp_department_save' );
						?>
	...
	<div class="row mt-3">
		<div class="col-lg-12">
			<?php li_mi_erp_render_search_bar( 'departments', __( 'Search Departments', 'lime-micro-erp' ), __( 'Search by name or description...', 'lime-micro-erp' ), array(), $search ); ?>
		</div>
	</div>
	...
	<div class="row mt-1">
		<div class="col-lg-12">
				<div class="bg-light p-3 rounded shadow-sm border">
									...
									<tr>
										...
										<td>
											<div class="pos-row-actions">
												<a href="<?php echo esc_url( li_mi_erp_admin_url( 'departments', array( 'edit' => $row->id ) ) ); ?>" class="pos-action edit pos-icon" aria-label="<?php esc_attr_e( 'Edit', 'lime-micro-erp' ); ?>" title="<?php esc_attr_e( 'Edit', 'lime-micro-erp' ); ?>"><span class="dashicons dashicons-edit" aria-hidden="true"></span></a>
												<form method="post" action="" class="inline-form" onsubmit="return confirm('<?php esc_attr_e( 'Delete this department?', 'lime-micro-erp' ); ?>');">
													<?php wp_nonce_field( 'li_mi_erp_department_delete' ); ?>
													<input type="hidden" name="li_mi_erp_action" value="delete_department">
					...
					<?php li_mi_erp_render_pagination( 'departments', $total_items, $per_page ); ?>
