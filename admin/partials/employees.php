...
<div class="wrap micro-erp-page">
	<h1 class="wp-heading-inline mb-3">
		...
		<?php if ( ! $editing ) : ?>
			<a href="<?php echo esc_url( micro_erp_admin_url( 'employees', array( 'new' => '1' ) ) ); ?>" class="btn-primary"><?php esc_html_e( '+ Add Employee', 'micro-erp' ); ?></a>
		<?php endif; ?>
	</h1>
	...
	<?php if ( $editing || isset( $_GET['new'] ) ) : ?>
		...
		<form method="post" action="">
			...
			<div class="d-flex mt-2 mb-4">
				...
				<button type="submit" class="btn-success"><?php esc_html_e( 'Save Employee', 'micro-erp' ); ?></button>
			</div>
		</form>
				...
				<div class="bg-light p-3 rounded shadow-sm border">
					...
					<form method="get" action="" class="search-section mb-3">
						...
						<div class="search-toolbar d-flex flex-wrap align-items-center gap-2">
							<label for="employee-search" class="form-label mb-0"><?php esc_html_e( 'Search Employees', 'micro-erp' ); ?></label>
							<input type="text" name="s" id="employee-search" class="form-control form-control-sm search-field" placeholder="<?php esc_attr_e( 'Search employees...', 'micro-erp' ); ?>" value="<?php echo esc_attr( $search ); ?>">
							...
							?>
							<div class="filter-pills ml-auto" role="group" aria-label="<?php esc_attr_e( 'Filter by department', 'micro-erp' ); ?>">
								<a href="<?php echo esc_url( $all_url ); ?>" class="<?php echo esc_attr( ! $dept_filter ? 'active' : '' ); ?>"><?php esc_html_e( 'All Departments', 'micro-erp' ); ?></a>
								<?php foreach ( $departments as $dept ) : ?>
									...
									<tr>
										...
										<td>
											<div class="pos-row-actions">
												<a href="<?php echo esc_url( micro_erp_admin_url( 'employees', array( 'edit' => $row->id ) ) ); ?>" class="pos-action edit pos-icon" aria-label="<?php esc_attr_e( 'Edit', 'micro-erp' ); ?>" title="<?php esc_attr_e( 'Edit', 'micro-erp' ); ?>"><span class="dashicons dashicons-edit" aria-hidden="true"></span></a>
												<a href="<?php echo esc_url( micro_erp_admin_url( 'salary', array( 'month' => current_time( 'Y-m' ) ) ) ); ?>" class="pos-action edit"><?php esc_html_e( 'Salary', 'micro-erp' ); ?></a>
