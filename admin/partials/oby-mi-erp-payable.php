...
$ap_account = $wpdb->get_row( $wpdb->prepare( "SELECT * FROM {$wpdb->prefix}oby_mi_erp_accounts WHERE code = %s LIMIT %d", '2001', 1 ) );
...
<div class="wrap oby-mi-erp-page">
	...
	<div class="row mt-3">
		<div class="col-lg-12">
			<?php oby_mi_erp_render_search_bar( 'payable', __( 'Search Payables', 'obydullah-micro-erp' ), __( 'Search by description...', 'obydullah-micro-erp' ), array(), $search ); ?>
		</div>
	</div>
	...
	<div class="row mt-1">
		<div class="col-lg-12">
			<div class="bg-light p-3 rounded shadow-sm border">
						...
						<tbody class="bg-white">
							...
							<?php foreach ( $rows as $row ) : ?>
								<tr>
									...
									<td class="text-right"><strong style="color:#d63638;"><?php echo esc_html( oby_mi_erp_format_money( $row->payable_amount ) ); ?></strong></td>
									<td class="text-right"><a href="<?php echo esc_url( oby_mi_erp_admin_url( 'journal', array( 'view' => $row->entry_id ) ) ); ?>" class="pos-action edit pos-icon" aria-label="<?php esc_attr_e( 'View', 'obydullah-micro-erp' ); ?>" title="<?php esc_attr_e( 'View', 'obydullah-micro-erp' ); ?>"><span class="dashicons dashicons-visibility" aria-hidden="true"></span></a></td>
								</tr>
							<?php endforeach; ?>
							<tr class="total-row">
								<td colspan="3"><strong><?php esc_html_e( 'Total Payable', 'obydullah-micro-erp' ); ?></strong></td>
								<td class="text-right"><strong><?php echo esc_html( oby_mi_erp_format_money( $total ) ); ?></strong></td>
								<td></td>
							</tr>
						</tbody>
					</table>
				...
				<?php oby_mi_erp_render_pagination( 'payable', $total_items, $per_page ); ?>
