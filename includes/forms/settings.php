...
function li_mi_erp_handle_settings_form() {
	li_mi_erp_verify_nonce( 'li_mi_erp_settings_save' );
	...
	foreach ( $settings as $key => $value ) {
		li_mi_erp_set_setting( $key, $value );
	}

	li_mi_erp_audit_log( 'save', 'settings', 0, 'Updated plugin settings' );
	li_mi_erp_redirect_notice( __( 'Settings saved.', 'lime-micro-erp' ) );
}
